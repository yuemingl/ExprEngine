...
public class ArrayAccessNode extends ExprNode {
	...
	public ArrayAccessNode nextDim; //next dimension of array access. e.g. a[i][j][k]
	...
	public ArrayAccessNode(VariableNode var, ExprNode idxS, ExprNode idxE, 
			VariableNode retVar, ArrayAccessNode nextDim) {
		this.var = var;
		this.idxS = idxS;
		this.idxE = idxE;
		this.retVar = retVar;
	...
	public void genCode(MethodGenHelper mg) {
		if(null != this.nextDim) {
			this.nextDim.genCode(mg);
		}
		var.genCode(mg);
		if(null == idxE) {
			idxS.genCode(mg);
