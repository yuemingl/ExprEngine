...
public class ExprGrammarParser extends Parser {
	...
	public static final int
		...
		RULE_logical_entity = 8, RULE_numeric_entity = 9;
	public static final String[] ruleNames = {
		"prog", "asign", "expr", "logical_expr", "comparison_expr", "comparison_operand", 
	...
	public static class AsignContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ExprGrammarListener ) ((ExprGrammarListener)listener).enterAsign(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ExprGrammarListener ) ((ExprGrammarListener)listener).exitAsign(this);
		}
	}
