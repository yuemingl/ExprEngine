...
#### 1. A quick example: parse and evaluate. (Note: the bytecode will be generated each time when using function ExprEngine.exec(). See examples in sections 2,3 and 4 below for more efficient ways.)
```Java
